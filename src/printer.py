...
class Node:
    ...
    def print_tree(self, feature_names, class_names, show_details):
        ...
        lines, _, _, _ = self._printer_aux(
            feature_names, class_names, show_details, root=True
        )
        for line in lines:
            print(line)

    def _printer_aux(self, feature_names, class_names, show_details, root=False):
        ...
        left, n, p, x = self.left._printer_aux(feature_names, class_names, show_details)
        right, m, q, y = self.right._priinter_aux(feature_names, class_names, show_details)
